    ...
    <>
      ...
      >
        <div className="container mx-auto px-8">
          <div className="max-w-full md:max-w-[632px] h-[30px] text-[#AC87C5] text-2xl font-extrabold font-manrope mb-10">
      ...
      <div
        className="flex flex-col items-center md:px-32 px-5 my-10"
      ...
      <div className="relative" data-aos="fade-down" data-aos-duration="1200">
